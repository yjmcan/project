...
Page({
  ...
  my_group: function (e) {
    ...
    wx.navigateTo({
      url: 'collageInfo?id=' + info.group_id + '&user_id=' + info.user_id + '&goods_id=' + info.goods_id,
    })
  },
  // Buy again
  buy: function (e) {
    let info = this.data.info
    wx.navigateTo({
      url: '/zh_cjdianc/pages/collage/index?id=' + info.goods_id + '&store_id=' + info.store_id,
    })
  },
  // View more products
  more: function (e) {
