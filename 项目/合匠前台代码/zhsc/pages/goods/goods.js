...
Page({
  ...
  onLoad: function (t) {
    ...
    if (void 0 != d) e = d;
      ...
      console.log("scene obj=>" + JSON.stringify(u)),
        u.uid && u.gid ? (e = u.uid, t.id = u.gid) : e = c
    }
    o.loginBindParent({
      parent_id: e
    });
      ...
      success: function (t) {
        if (0 == t.code) {
          ...
          e.wxParse("detail", "html", o, a),
            ...
            a.data.goods.miaosha && a.setMiaoshaTimeOver(),
            a.selectDefaultAttr()
        }
  ...
  attrClick: function (a) {
    ...
    for (var n in r) {
      ...
      for (var d in r[n].attr_list) if (r[n].attr_list[d].checked) {
        c.push(r[n].attr_list[d].attr_id),
          l = !0;
        break
      }
      if (!l) {
