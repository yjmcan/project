...
Page({
  ...
  formSubmit: function (e) {
    ...
    var that = this;
    var user_id = wx.getStorageSync('UserData').id, name = e.detail.value.name, tel = e.detail.value.tel, cb = e.detail.value.checkbox.length;
